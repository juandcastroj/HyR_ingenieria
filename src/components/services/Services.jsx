      ...
      <section aria-labelledby="features-heading" className="relative">
        ...
        <div className="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 sm:pb-32 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:pt-32">
          <div className="lg:col-start-2">
            ...
            <dl className="mt-10 grid grid-cols-1 gap-x-8 gap-y-12 text-sm sm:grid-cols-2">
              {services.map((feature) => (
                <div key={feature.name}>
                  ...
                  <dt className="text-base font-semibold text-blue-900">{feature.name}</dt>
                  <dd className="mt-2 text-gray-500">{feature.description}</dd>
                  <dd className="mt-2 text-gray-700">{feature.attendant}</dd>
                  <dd className="mt-2 text-gray-500">{feature.contact}</dd>
