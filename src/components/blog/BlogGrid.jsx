              ...
              <a href={"#" + post.id}>
                ...
                <div className="max-w-xl">
                  ...
                  <div className="group relative">
                    <h3 className="mt-3 text-lg/6 font-semibold text-blueText group-hover:text-gray-600">
                      <a href={post.href}>
                  ...
                  <div className="relative mt-8 flex items-center gap-x-4">
                    ...
                    <div className="text-sm/6">
                      <p className="font-semibold text-blueText">
                        <a href={post.author.href}>
                          <span className="absolute inset-0 text-blueText" />
                          {post.author.name}
                        </a>
                      </p>
